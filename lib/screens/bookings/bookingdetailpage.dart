...
class BookingDetailsPage extends StatefulWidget {
  ...
  const BookingDetailsPage(
      {super.key, required this.booking, this.onBookingUpdated});
...
class _BookingDetailsPageState extends State<BookingDetailsPage> {
                      ...
                      children: [
                        ...
                        _buildSectionCard(
                          ...
                          [
                            ...
                            _buildDetailRow('Email',
                                ...
                                maxLines: 10),
                            _buildDetailRow(
                                'Total Guests', booking.totalGuests.toString()),
                          ],
                        ),
                        ...
                        _buildSectionCard(
                          ...
                          [
                            ...
                            _buildDetailRow(
                                'Booking Date', _formatDate(booking.date)),
                        ...
                        _buildSectionCard(
                          ...
                          [
                            _buildDetailRow('Property Name',
                                booking.propertyName ?? 'Not specified'),
                        ...
                        _buildSectionCard(
                          ...
                          const Color(0xFF1F2937),
                          [
                            _buildRoomPairsRow('Room(s)', booking.roomType,
                          ...
                          _buildSectionCard(
                            ...
                            [
                              for (final addOn in booking.addOns)
                                _buildDetailRow(
                                    addOn.name, _formatCurrency(addOn.price)),
                            ],
                          ),
                        ],
                                    ...
                                    onTap: () {
                                      Navigator.of(context)
                                        ...
                                        if (result == true ||
                                          ...
                                          try {
                                            print(
                                                '🔄 Refreshing booking details for ID: ${booking.id}');
                                            final res = await BookingsService
                                            ...
                                            if (res['success'] == true) {
                                              ...
                                              if (payload
                                                ...
                                                print(
                                                    '🔍 Updated booking data: $payload');
                                                print(
                                                    '🔍 Room types in response: ${payload['room_types']}');
                                                print(
                                                    '🔍 Rooms in response: ${payload['rooms']}');
                                                print(
                                                    '🔍 Booking rooms in response: ${payload['booking_rooms']}');

                                                // Always use form data if available, otherwise use API data
                                                final updatedBooking =
                                                    Booking.fromMap(payload);
                                                print(
                                                    '🔍 Parsed room type: "${updatedBooking.roomType}"');
                                                print(
                                                    '🔍 Parsed selected room: "${updatedBooking.selectedRoom}"');
                                                ...
                                                if (result is Map &&
                                                  ...
                                                  formSelectedRoom =
                                                      result['roomData']
                                                          ['selectedRoom'];
                                                  print(
                                                      '🔍 Form room data: "$formRoomType" / "$formSelectedRoom"');
                                                }
                                                ...
                                                if (formRoomType != null &&
                                                  ...
                                                  print(
                                                      '🔄 Using form room data for dynamic update');
                                                  ...
                                                  final dynamicBooking =
                                                    ...
                                                    companyName: updatedBooking
                                                        .companyName,
                                                    imageUrl:
                                                        updatedBooking.imageUrl,
                                                    date: updatedBooking.date,
                                                    status:
                                                        updatedBooking.status,
                                                    amountSpend: updatedBooking
                                                        .amountSpend,
                                                    balanceDue: updatedBooking
                                                        .balanceDue,
                                                    address:
                                                        updatedBooking.address,
                                                    notes: updatedBooking.notes,
                                                    checkInDate: updatedBooking
                                                        .checkInDate,
                                                    checkOutDate: updatedBooking
                                                        .checkOutDate,
                                                    roomDetails: updatedBooking
                                                        .roomDetails,
                                                    bookingFee: updatedBooking
                                                        .bookingFee,
                                                    customer:
                                                        updatedBooking.customer,
                                                    totalGuests: updatedBooking
                                                        .totalGuests,
                                                    remarks:
                                                        updatedBooking.remarks,
                                                    roomType:
                                                        formRoomType, // Use form room type
                                                    selectedRoom:
                                                        formSelectedRoom, // Use form selected room
                                                    roomRemarks: updatedBooking
                                                        .roomRemarks,
                                                    roomTypeId: updatedBooking
                                                        .roomTypeId,
                                                    roomId:
                                                        updatedBooking.roomId,
                                                    propertyName: updatedBooking
                                                        .propertyName,
                                                    propertyAddress:
                                                        updatedBooking
                                                            .propertyAddress,
                                                    propertyId: updatedBooking
                                                        .propertyId,
                                                    paymentStatus:
                                                        updatedBooking
                                                            .paymentStatus,
                                                    source:
                                                        updatedBooking.source,
                                                    subtotal:
                                                        updatedBooking.subtotal,
                                                    gst: updatedBooking.gst,
                                                    totalCost: updatedBooking
                                                        .totalCost,
                                                    discount:
                                                        updatedBooking.discount,
                                                    finalAmount: updatedBooking
                                                        .finalAmount,
                                                    guests:
                                                        updatedBooking.guests,
                                                    guide: updatedBooking.guide,
                                                    extras:
                                                        updatedBooking.extras,
                                                    addOns:
                                                        updatedBooking.addOns,
                                                  );

                                                  print(
                                                      '🔍 Dynamic room data: "${dynamicBooking.roomType}" / "${dynamicBooking.selectedRoom}"');

                                                  setState(() {
                                                    booking = dynamicBooking;
                                                  });
                                                  print(
                                                      '✅ Booking details updated with dynamic form data');
                                                } else {
                                                  setState(() {
                                                    booking = updatedBooking;
                                                  });
                                                  print(
                                                      '✅ Booking details updated with API data');
                                                }
                                              }
                                            } else {
                                              print(
                                                  '⚠️ Failed to fetch updated booking: ${res['message']}');
                                            }
                                          } catch (e) {
                                            print(
                                                '💥 Error refreshing booking details: $e');
                                          }
                                          if (!mounted) return;
  ...
  Widget _buildDetailRow(String label, String value,
      {int maxLines = 3, TextAlign? align}) {
    return Padding(
        ...
        children: [
          ...
          Expanded(
            ...
            child: Text(
              ...
              overflow:
                  maxLines == 10 ? TextOverflow.clip : TextOverflow.ellipsis,
              maxLines: maxLines,
            ),
          ),
        ],
  ...
  Widget _buildRoomPairsRow(
      String label, String roomTypesCsv, String roomsCsv) {
    final roomTypes =
        (roomTypesCsv.isNotEmpty ? roomTypesCsv.split(',') : <String>[])
            .map((e) => e.trim())
    ...
    try {
      ...
      if (res['success'] == true) {
        ...
        if (payload is Map<String, dynamic>) {
          ...
          if (updatedBooking.roomType.isEmpty ||
              updatedBooking.selectedRoom.isEmpty ||
              updatedBooking.roomType.contains('GLU13') ||
              updatedBooking.selectedRoom.contains('GLU13')) {
            ...
            final preservedBooking = Booking(
              ...
              selectedRoom:
                  booking.selectedRoom, // Preserve current selected room
